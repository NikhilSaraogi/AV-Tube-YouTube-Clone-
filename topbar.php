...
<nav class="navbar navbar-light navbar-expand-lg fixed-top bg-info" style="padding:0">
  <div class="container">
	    <a class="navbar-brand js-scroll-trigger text-white" href="./"><img src="assets\img\logo.png" alt="Girl in a jacket" style="width:70px;height:50px;"><b>AV Tube</b></a>
